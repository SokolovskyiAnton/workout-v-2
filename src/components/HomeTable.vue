...
<div>
    ...
    <div class="button">
        <b-button @click="createTable" class="button-submit" variant="outline-primary">Сохранить</b-button>
    </div>
</div>
</template>
    ...
    methods: {
        ...
        createTable() {
            const obj = {
                ...
                names: {
                    firstExercise: this.names.firstName,
                    secondExercise: this.names.secondName,
